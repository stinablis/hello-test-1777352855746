...
export default function Home() {
  ...
  const products = [{ n: 'test', d: 'Our \'test\' product is a cutting-edge solution designed to provide users with a unique and seamless experience, combining advanced technology with intuitive design to make it an essential tool for anyone looking to streamline their workflow. With its robust features and user-friendly interface, it is an ideal choice for both beginners and professionals.', i: 'https://images.pexels.com/photos/7038233/pexels-photo-7038233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'test', d: 'The \'test\' product is a premium offering that boasts an impressive array of features, including advanced analytics, real-time tracking, and personalized insights, making it an indispensable asset for businesses seeking to optimize their operations and gain a competitive edge.', i: 'https://images.pexels.com/photos/7038233/pexels-photo-7038233.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'test', d: 'Our \'test\' product is a versatile and adaptable solution that can be tailored to meet the specific needs of our customers, providing them with a customized experience that addresses their unique challenges and goals. With its flexible design and scalable architecture, it is an excellent choice for organizations of all sizes.', i: 'https://images.pexels.com/photos/17658363/pexels-photo-17658363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'test', d: 'The \'test\' product is a groundbreaking innovation that leverages the latest advancements in technology to deliver a fast, secure, and efficient experience, making it an attractive option for individuals and businesses seeking to enhance their productivity and stay ahead of the curve.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'test', d: 'Our \'test\' product is a comprehensive and integrated solution that brings together a range of tools and features to provide users with a unified and cohesive experience, enabling them to streamline their workflow, reduce complexity, and achieve their objectives with greater ease and precision.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Hello Test, we are a innovative company dedicated to providing high-quality products that cater to the diverse needs of our customers. Our team of experts is committed to delivering exceptional service and ensuring customer satisfaction. With a strong focus on excellence, we strive to be at the forefront of our industry.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to become a leading provider of innovative products, renowned for our commitment to quality, customer satisfaction, and exceptional service.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to design, develop, and deliver top-notch products that exceed our customers\' expectations, while fostering a culture of innovation, teamwork, and continuous improvement.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">tets</h4>
                  <p className="text-sm text-on-surface-variant">At Hello Test, our first core value, \'tets\', represents our commitment to integrity, honesty, and transparency in all our interactions, whether with customers, partners, or employees.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">test</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value, \'test\', embodies our passion for innovation, creativity, and excellence, driving us to push boundaries, challenge the status quo, and strive for perfection in everything we do.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/9068381/pexels-photo-9068381.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
